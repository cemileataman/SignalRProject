...
namespace SignalRApi.Hubs
{
	public class SignalRHub : Hub
	{
		...
		public async Task SendeProgress()
		{
			...
			var value9 =_productService.TProductByPriceSteakBurger();
			await Clients.All.SendAsync("ReceiveProductByPriceSteakBurger", value9);
